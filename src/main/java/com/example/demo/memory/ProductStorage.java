...
// // //     private void saveInsertSql(Product product) {
// // //         String sql = String.format(
// // //                 "INSERT INTO `products` (`id`, `code`, `name`, `category`, `brand`, `type`, `description`) VALUES (%d, '%s', '%s', '%s', '%s', '%s', '%s');",
// // //                 product.getId(), product.getCode(), product.getName(), product.getCategory(),
...
// // //     private void saveUpdateSql(Product product) {
// // //         String sql = String.format(
// // //                 "UPDATE `products` SET `name`='%s', `category`='%s', `brand`='%s', `type`='%s', `description`='%s' WHERE `code`='%s';",
...
// // //     private void saveDeleteSql(String code) {
// // //         String sql = String.format("DELETE FROM `products` WHERE `code`='%s';", code);
// // //         appendSqlToFile(sql);
// // //     }

// // //     private void appendSqlToFile(String sql) {
// // //         String userHome = System.getProperty("user.home");
// // //         Path filePath = Paths.get(userHome,"Downloads", "demo", "demo", "product.sql");
// // //         try (BufferedWriter bw = Files.newBufferedWriter(filePath, StandardOpenOption.CREATE, StandardOpenOption.APPEND)) {
// // //             bw.write(sql);
// // //             bw.newLine();
// // //         } catch (Exception ex) {
// // //             throw new RuntimeException("Failed to append SQL to file", ex);
// // //         }
// // //     }
